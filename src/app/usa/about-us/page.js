...
export default async function AboutPage() {
  ...
  const [header, beginnings, commitments, privileged, getStart, ourTeams] =
    await Promise.all([
      getOriginData(ORIGINS.US, "/about-header?populate=*"),
      getOriginData(ORIGINS.US, "/about-our-beginnings?populate=*"),
      getOriginData(ORIGINS.US, "/about-we-are-recognized?populate=items&populate=items.image"),
      getOriginData(ORIGINS.US, "/privileged-to-be?populate=logos.logo"),
      getOriginData(ORIGINS.US, "/lets-get-started?populate=*"),
      getOriginData(ORIGINS.US, "/about-team?populate=about_team_items.image"),
    ]);
