...
export default async function WhyUsPage() {
  ...
  const [header, professionals, peoples, howWeDo, heroSection, getStart] =
    await Promise.all([
      getOriginData(ORIGINS.US,"/why-us-header?populate=*"),
      getOriginData(ORIGINS.US,"/why-us-professional?populate=*"),
      getOriginData(ORIGINS.US,"/why-us-peoples?populate=*"),
      getOriginData(ORIGINS.US,"/why-us-how-we-do?populate=*"),
      getOriginData(ORIGINS.US,"/why-us-work-with?populate=*"),
