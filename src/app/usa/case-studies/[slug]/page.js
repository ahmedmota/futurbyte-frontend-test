...
export default async function page({ params }) {
  ...
  async function getDynamicPageData(endPoint, getAll = false) {
    ...
    const data = await getOriginData(ORIGINS.US,endPointWithSlug);
  ...
  // const getHeader = await getOriginData(ORIGINS.US,"/case-study-inner-page-header?populate=*");
  // const getAboutStiches = await getOriginData(ORIGINS.US,
  //   "/case-study-inner-page-about-stitch?populate=*"
  // );
  // const getShowCases = await getOriginData(ORIGINS.US,
  //   "/case-study-inner-page-project-showcase?populate=*"
  // );
  // const getEndToEnd = await getOriginData(ORIGINS.US,
  //   "/case-study-inner-page-an-end-to-end?populate=*"
  // );
  // const getOutcomes = await getOriginData(ORIGINS.US,
  //   "/case-study-inner-page-project-outcome?populate=*"
  // );
  // const getLetsWorkTogether = await getOriginData(ORIGINS.US,
  //   "/case-study-inner-page-lets-work-together?populate=*"
  // );
  // const getCaseStudies = await getOriginData(ORIGINS.US,
