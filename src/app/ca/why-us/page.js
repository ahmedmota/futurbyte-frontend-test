...
export default async function WhyUsPage() {
  ...
  const [header, professionals, peoples, howWeDo, heroSection, getStart] =
    await Promise.all([
      getOriginData(ORIGINS.CA,"/why-us-header?populate=*"),
      getOriginData(ORIGINS.CA,"/why-us-professional?populate=*"),
      getOriginData(ORIGINS.CA,"/why-us-peoples?populate=*"),
      getOriginData(ORIGINS.CA,"/why-us-how-we-do?populate=*"),
      getOriginData(ORIGINS.CA,"/why-us-work-with?populate=*"),
