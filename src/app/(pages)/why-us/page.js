...
export default async function WhyUsPage() {
  ...
  const [header, professionals, peoples, howWeDo, heroSection, getStart] =
    await Promise.all([
      getData("/why-us-header?populate=*"),
      getData("/why-us-professional?populate=*"),
      getData("/why-us-peoples?populate=*"),
      getData("/why-us-how-we-do?populate=*"),
      getData("/why-us-work-with?populate=*"),
