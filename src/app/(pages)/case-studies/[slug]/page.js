...
export default async function page({ params }) {
  ...
  // const getHeader = await getData("/case-study-inner-page-header?populate=*");
  // const getAboutStiches = await getData(
  //   "/case-study-inner-page-about-stitch?populate=*"
  // );
  // const getShowCases = await getData(
  //   "/case-study-inner-page-project-showcase?populate=*"
  // );
  // const getEndToEnd = await getData(
  //   "/case-study-inner-page-an-end-to-end?populate=*"
  // );
  // const getOutcomes = await getData(
  //   "/case-study-inner-page-project-outcome?populate=*"
  // );
  // const getLetsWorkTogether = await getData(
  //   "/case-study-inner-page-lets-work-together?populate=*"
  // );
  // const getCaseStudies = await getData(
