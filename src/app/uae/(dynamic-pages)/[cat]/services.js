...
export async function getAllData(dynamicPageName) {
  ...
  const allData = await Promise.all([
    ...
    getOriginData(ORIGINS.UAE,"/case-studies-inner-page-headers?populate=thumbnail&fields[0]=title&fields[1]=short_description&fields[2]=slug&sort=createdAt:desc"),
    getDynamicPageData(
