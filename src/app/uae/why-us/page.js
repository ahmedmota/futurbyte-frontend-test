...
export default async function WhyUsPage() {
  ...
  const [header, professionals, peoples, howWeDo, heroSection, getStart] =
    await Promise.all([
      getOriginData(ORIGINS.UAE,"/why-us-header?populate=*"),
      getOriginData(ORIGINS.UAE,"/why-us-professional?populate=*"),
      getOriginData(ORIGINS.UAE,"/why-us-peoples?populate=*"),
      getOriginData(ORIGINS.UAE,"/why-us-how-we-do?populate=*"),
      getOriginData(ORIGINS.UAE,"/why-us-work-with?populate=*"),
